...
var header = {
  ...
  address: 'м.Одеса, вул. Тираспольське шосе 14',
}
var footer = {
  social: {
    email: {
      text: 'ibr.israfilov@gmail.com',
      href: 'mailto:ibr.israfilov@mail.com',
    },
    phone: {
      text: '+380679975443',
      href: 'tel:+380679975443',
    },
    linkedin: {
      text: 'LinkedIn',
  ...
  res.render('education', {
    ...
    main: {
      ...
      educations: [
        ...
        {
          name: 'Коледж звязку та інформатизації',
          isEnd: true,
        },
        {
          name: 'ОНАЗ ім. О.С. Попова',
          isEnd: false,
        },
      ],
    },
